    ...
    <div className="min-h-screen bg-medical-background p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card
            className="border-medical-border cursor-pointer hover:shadow-md transition-all hover:border-medical-primary/50"
          ...
          >
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <ArrowRight className="h-5 w-5 text-medical-text-secondary" />
              </div>
            </CardHeader>
            <CardContent>
